...
public class Node {
   ...
   * @param local is whether or not you want to use local ip or WAN ip
   */
   ...
   * 
   * @return - A list of strings containing the folder locations of the node storage, address table,
   *         and updater
   */
  ...
  public enum ModuleStatus {
    GREEN(""), YELLOW("Not Current."), RED("Not Working."), BLACK("Broken."), NA("Not Implemented");
    public String msg;

    ModuleStatus(String msg) {
      this.msg = msg;
    }
  ...
  public Map<String, ModuleStatus> statusCheck() {
    return null;
  }
   ...
   */
  public String statusChecktoString() {
    return null;
  }

  public ModuleStatus checkStorage() {
    return ModuleStatus.NA;
  }

  public ModuleStatus checkUpdater() {
    return ModuleStatus.NA;
  }

  public ModuleStatus checkServer() {
    Node.getInstance();
    if(server.isRunning()){
      return ModuleStatus.GREEN;
    }else{
      return ModuleStatus.RED;
    }
  }

  public ModuleStatus checkAddressTable() {
    return null;
  }
  ...
  public static class NodeBuilder {
    ...
    /**
     * Sets the directory where the node should be spawned and operated from Passed from DART.Join
     * 
     * @param directory - Directory to be used by created node
     */
    ...
    /**
     * Builds a node based on the current list of settings attributed to it. TODO add and start
     * updater
     * 
